...
INSERT INTO `history_lelang` (`id_history`, `id_barang`, `id_user`, `penawaran_harga`) VALUES
(1, 1, 1, 50000),
(2, 1, 1, 52000);
...
INSERT INTO `tb_barang` (`id_barang`, `nama_barang`, `tgl`, `tgl_akhir`, `harga_awal`, `deskripsi_barang`, `status`) VALUES
(1, 'ok', '2020-03-02', '2020-03-27', 50000, 'ok', 'ditutup'),
(2, 'ok2', '2020-03-31', '2020-04-02', 20000, 'ok', 'dibuka');
...
(1, 'Viona', 'viona', '$2y$10$6baT.vf3xeUGScenmS0qRenchP8p5c5lWDOxbGSKoBpLIGf65Nk5O', '081929394212');
...
(1, 1, '2020-03-28', 52000, 1, 'lunas', '5e7ecfaa92198.png'),
(3, 0, '2020-03-10', 2020, 20000, '', '');
...
(1, 'admin', 'admin', '$2y$10$6baT.vf3xeUGScenmS0qRenchP8p5c5lWDOxbGSKoBpLIGf65Nk5O', 1);
